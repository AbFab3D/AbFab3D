...
public class UICreator {
    public static final void main(String[] args) {
        RingTorusKernel kernel = new RingTorusKernel();
...
System.out.println("Creating Java User Interface for imageeditor");
        ...
        uic.createInterface("ringtorus.ui", "Editor", "AbFab3D Ring Creator","src/java/ringtorus/ui", steps, new HashMap<String,String>(), kernel, new HashSet<String>());

System.out.println("Creating HTML User Interface for imageeditor");
        BasicHTMLUICreator uic2 = new BasicHTMLUICreator();

        uic2.createInterface("ringtorus.ui", "Editor", "AbFab3D Image Creator","src/html/ringtorus", steps, new HashMap<String,String>(), kernel, new HashSet<String>());
