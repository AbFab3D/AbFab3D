...
public class UICreator {
    public static final void main(String[] args) {
        SnowFlakeKernel kernel = new SnowFlakeKernel();
...
System.out.println("Creating Java User Interface for imageeditor");
        ...
        uic.createInterface("dla.ui", "Editor", "AbFab3D Image Creator","src/java/dla/ui", steps, new HashMap<String,String>(), kernel, new HashSet<String>());

System.out.println("Creating HTML User Interface for imageeditor");
        BasicHTMLUICreator uic2 = new BasicHTMLUICreator();

        uic2.createInterface("dla.ui", "Editor", "AbFab3D Image Creator","src/html/dla", steps, new HashMap<String,String>(), kernel, new HashSet<String>());
