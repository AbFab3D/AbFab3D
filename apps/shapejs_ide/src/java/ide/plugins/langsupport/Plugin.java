...
import ide.plugins.langsupport.typescript.TypeScriptSupport;
import ide.plugins.sourcebrowser.SourceBrowserPlugin;
...
import ide.ui.rtextarea.RTextAreaOptionPanel;
...
public class Plugin extends GUIPlugin {
	...
	private static final String MSG = "ide.plugins.langsupport.Plugin";
	...
	public void install(AbstractPluggableGUIApplication<?> app) {
		...
		System.setProperty(
				...
				"ide.plugins.langsupport.JavaSourceBrowserTreeConstructor");
		System.setProperty(
				SourceBrowserPlugin.CUSTOM_HANDLER_PREFIX + RSyntaxTextArea.SYNTAX_STYLE_JAVASCRIPT,
				"ide.plugins.langsupport.JavaScriptSourceBrowserTreeConstructor");
		System.setProperty(
				SourceBrowserPlugin.CUSTOM_HANDLER_PREFIX + RSyntaxTextArea.SYNTAX_STYLE_XML,
				"ide.plugins.langsupport.XmlSourceBrowserTreeConstructor");
