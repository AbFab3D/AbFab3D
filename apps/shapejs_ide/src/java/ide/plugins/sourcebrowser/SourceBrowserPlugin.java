 ...
 */
package ide.plugins.sourcebrowser;
...
import ide.*;
import ide.optionsdialog.OptionsDialog;
...
public class SourceBrowserPlugin extends GUIPlugin
	...
	static final String BUNDLE_NAME		=
					"ide.plugins.sourcebrowser.SourceBrowser";
	...
	private static final String RENDERER_WRAPPER_CLASS_NAME =
		"ide.plugins.sourcebrowser.SubstanceTreeCellRendererWrapper";
	...
	private static final File getPrefsFile() {
		File ret =
		new File(RTextUtilities.getPreferencesDirectory(),
