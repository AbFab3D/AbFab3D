...
public class UICreator {
    public static final void main(String[] args) {
        StemFastenerKernel kernel = new StemFastenerKernel();
...
System.out.println("Creating Java User Interface for imageeditor");
        ...
        uic.createInterface("stemfastener.ui", "Editor", "AbFab3D Stem Fastener","src/java/stemfastener/ui", steps, new HashMap<String,String>(), kernel, new HashSet<String>());
