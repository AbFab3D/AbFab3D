...
import abfab3d.grid.BaseAttributeWrapper;
import abfab3d.grid.BaseWrapper;
 ...
 * @author Alan Hudson
 */
public class AttributeGridSourceWrapper extends BaseAttributeWrapper implements SourceWrapper {
    private String source;

    public AttributeGridSourceWrapper(String source, AttributeGrid grid) {
        super(grid);
    ...
    public AttributeGridSourceWrapper(AttributeGrid grid) {
        super(grid);
    }
