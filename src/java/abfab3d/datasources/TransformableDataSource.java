...
public abstract class TransformableDataSource extends BaseParameterizable implements DataSource, Initializable {
    ...
    // compilation flag to make shapes dta source to use signed distance 

    public static final int DATA_DISTANCE = 1;
    public static final int DATA_DENSITY = 0;
    // type of data generated by this data source 
    protected int m_dataType = DATA_DENSITY;
