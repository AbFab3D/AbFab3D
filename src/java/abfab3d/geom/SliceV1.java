 ...
 */
public class SliceV1 implements Slice {
    ...
    public SliceV1(Vector3d normal, Vector3d pointOnPlane){        
        this(normal, pointOnPlane,EPSILON);
    }

    public SliceV1(Vector3d normal, Vector3d pointOnPlane, double epsilon){
