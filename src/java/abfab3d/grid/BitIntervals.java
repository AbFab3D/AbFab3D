...
public class BitIntervals implements RowOfInt, Serializable {
    ...
    public BitIntervals(){
        ...
        //m_intervals = new short[]{7, 10, 11,12, 17,21, 22, 23, 25, 30};m_curcount = m_intervals.length;
        //m_intervals = new short[]{1,2,3,38};m_curcount = m_intervals.length;
        //m_intervals = new short[]{-1,39};m_curcount = m_intervals.length;
