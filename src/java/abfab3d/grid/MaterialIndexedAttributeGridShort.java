 ...
 * @author Alan Hudson
 */
public class MaterialIndexedAttributeGridShort extends BaseAttributeGrid {
     ...
     */
    public Object clone() {
        MaterialIndexedAttributeGridShort grid = new MaterialIndexedAttributeGridShort(this);
