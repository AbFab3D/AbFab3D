 ...
 * @author Alan Hudson
 */
public class MaterialIndexedGridShort extends BaseGrid {
     ...
     */
    public MaterialIndexedGridShort(double w, double h, double d, double pixel, double sheight) {
     ...
     * @param sheight The slice height in meters
     */
    public MaterialIndexedGridShort(int w, int h, int d, double pixel, double sheight) {
    ...
    public Grid createEmpty(int w, int h, int d, double pixel, double sheight) {
        Grid ret_val = new MaterialIndexedGridShort(w,h,d,pixel,sheight);
     ...
     * @param grid The grid
     */
    public MaterialIndexedGridShort(MaterialIndexedGridShort grid) {
     ...
     */
    public Object clone() {
        MaterialIndexedGridShort grid = new MaterialIndexedGridShort(this);
