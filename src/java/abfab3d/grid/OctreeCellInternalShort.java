 ...
 * @author Alan Hudson
 */
public class OctreeCellInternalShort implements OctreeCell, Cloneable {
    ...
    /** The children cells */
    protected OctreeCellInternalShort[] children;

    /** The state of this cell and all children or -1 if mixed */
    protected VoxelData allState;

    protected OctreeCellInternalShort() {
    }

    public OctreeCellInternalShort(int level, int maxLevel, int x, int y, int z, int size, byte state, long material) {
        this.level = level;
...
//System.out.println("Create grid: level: " + level + " size: " + size + " state: " + state + " orig: " + x + " " + y + " " + z + " hc: " + hashCode());
        ...
        allState = new VoxelDataShort(state, material);
    }
...
if (DEBUG) System.out.println("Setting dataInternal: " + x + " " + y + " " + z + " new_state: " + state + " new_mat: " + material);
     ...
     * @param material The voxel material
     */
    protected void setData(OctreeCellInternalShort parent, int x, int y, int z, byte state, long material) {
...
if (DEBUG) System.out.println("   mixed, oc: " + oc);
    ...
    private void createChild(int pos, byte state, long material) {
        ...
        switch(pos) {
            case 0:
                children[0] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy,vcz,
                    new_size, state, material);
                break;
            case 1:
                children[1] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy + new_size,vcz,
                    new_size, state, material);
                break;
            case 2:
                children[2] = new OctreeCellInternalShort(new_level,maxLevel,vcx + new_size,vcy + new_size,vcz,
                    new_size, state, material);
                break;
            case 3:
                children[3] = new OctreeCellInternalShort(new_level,maxLevel,vcx + new_size,vcy,vcz,
                    new_size, state, material);
                break;
            case 4:
                children[4] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy,vcz + new_size,
                    new_size, state, material);
                break;
            case 5:
                children[5] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy + new_size,vcz + new_size,
                    new_size, state, material);
                break;
            case 6:
                children[6] = new OctreeCellInternalShort(new_level,maxLevel,vcx + new_size,vcy + new_size,vcz + new_size,
                    new_size, state, material);
                break;
            case 7:
                children[7] = new OctreeCellInternalShort(new_level,maxLevel,vcx + new_size,vcy,vcz + new_size,
                    new_size, state, material);
                break;
        }
    }
    ...
    private void splitOld(int pos, byte oldState, int oldMaterial) {
        children = new OctreeCellInternalShort[8];
    ...
    private void split(int pos, byte oldState, long oldMaterial) {
        ...
        if (oldState == Grid.OUTSIDE) {
            ...
            children[pos] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy,vcz,
                new_size, oldState, oldMaterial);
        } else {
            children[0] = new OctreeCellInternalShort(new_level,maxLevel,vcx,vcy,vcz,
                new_size, oldState, oldMaterial);
     ...
     */
    private void collapse(byte state, long material, OctreeCellInternalShort parent) {
        ...
        OctreeCellInternalShort cell = null;
...
//System.out.println("   ret oct: " + ret_val);
     ...
     */
    public Object clone() {
        OctreeCellInternalShort ret_val = new OctreeCellInternalShort();
        ret_val.vcx = vcx;
        ret_val.vcy = vcy;
        ret_val.vcz = vcz;
        ret_val.size = size;
        ...
        if (children != null) {
            int len = children.length;
            ret_val.children = new OctreeCellInternalShort[len];
            for(int i=0; i < len; i++) {
                ret_val.children[i] = (OctreeCellInternalShort) ((OctreeCellInternalShort)children[i]).clone();
            }
        }

        ret_val.allState = (VoxelDataShort) allState.clone();
