...
public class VectorIndexerStructMap implements VectorIndexer {
     ...
     * Index Definition
     */
    static class IndexValue extends StructDataDefinition {
    ...
    static class LocationHashFunction implements HashFunction {

        @Override
            public final int calcHashCode(StructMixedData src, int srcIdx) {
        ...
        @Override
            public final boolean calcEquals(StructMixedData src, int a, int b) {
    ...
    }  // static class LocationHashFunction        
}
