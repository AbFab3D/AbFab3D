...
public class SliceMaker {
    ...
    /**
     * render slice of given channelID for given DataSource using into prealocated image array in ARGB format 
     * 
     * 
     */
    public void renderSlice(int nu, int nv, Vector3d origin, Vector3d pntu, Vector3d pntv, DataSource dataSource, int channelID, ColorMapper colorMapper, int [] imageData){
