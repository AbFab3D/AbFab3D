 ...
 * @author Alan Hudson
 */
public class AttributedMeshArray implements AttributedMesh {
    private ArrayList<Triangle> m_tris;
    private Bounds m_bounds;
    private DataSource m_attributeCalculator;
    private int m_dim=3;

    public AttributedMeshArray() {
        this(3);
    }

    public AttributedMeshArray(int dataDimension) {
     ...
     */
    public AttributedMeshArray(int dataDimension, int ntris) {
        m_dim = dataDimension;
