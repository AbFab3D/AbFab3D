...
/**
 * This class is used to load a file and parse X3D files into an array of
 * coordinates and an array of vertices.
 *
 * This class only supports Triangle* and IndexedTriangle* nodes.
 * No Transform hierarchy is supported.  Use Xj3D's filter chain to flatten as needed.
 *
 * @author Alan Hudson
...
public class X3DLoader
    ...
    /** String message to use if a file does not contain TriangleSets* */
     ...
     * Constructor
     */
    public X3DLoader(boolean premult){
        //
        ...
        validNodes.add("TriangleFanSet");
        validNodes.add("TriangleSet");
        validNodes.add("TriangleStripSet");
    }
     ...
     * @throws org.web3d.vrml.lang.VRMLException This call is taken at the wrong time in the
     *   structure of the document.
     */
    ...
    public void endNode() throws SAVException, VRMLException {
        ...
        if (validNodes.contains(nodeName)) {
            ...
            if (vertices == null && coordinates != null && nodeName.startsWith("Triangle")) {
                // fill in vertices for Triangle* nodes based on  Coordinate count
                int tris = coordinates.length / 3;
                vertices = new int[tris];
            ...
            if (coordinates == null || vertices == null) {
                System.out.println("IndexedTriangle* geometry not well defined.");
     ...
     * {@link org.web3d.vrml.sav.StringContentHandler#fieldValue(String)}. or any of the
     * fieldValue methods in {@link org.web3d.vrml.sav.BinaryContentHandler}. This
     ...
     * should only be called by loadFile
     *
    ...
    /**
     * Get the coordinates.  Only call if {@link #processFile(java.io.File)}
     * has been called.
    ...
    /**
     * Get the vertex indices.  Only call if {@link #processFile(java.io.File)}
     * has been called.
