...
public class BoxSimplifiedX3DExporter implements Exporter {
    ...
    public BoxSimplifiedX3DExporter(String encoding, OutputStream os, ErrorReporter console) {
     ...
     */
    public BoxSimplifiedX3DExporter(BinaryContentHandler exporter, ErrorReporter console, boolean complete) {
        this.console = console;
...
//System.out.println("   coord(wc): " + x + " " + y + " " + z);
                    ...
                    if (displayFront) {
                        // Front Face
                        mesh.addFace(lfr_coord, ufr_coord, ufl_coord);
                        mesh.addFace(lfr_coord, ufl_coord, lfl_coord);
                    }
                    ...
                    if (displayBack) {
                        ...
                        mesh.addFace(lbr_coord, ubl_coord, ubr_coord);
                        mesh.addFace(lbr_coord, lbl_coord, ubl_coord);
                    }
                    ...
                    if (displayRight) {
                        // Right Face
                        mesh.addFace(lbr_coord, ubr_coord, ufr_coord);
                        mesh.addFace(lbr_coord, ufr_coord, lfr_coord);
                    }
                    ...
                    if (displayLeft) {
                        ...
                        mesh.addFace(lbl_coord, ufl_coord, ubl_coord);
                        mesh.addFace(lbl_coord, lfl_coord, ufl_coord);
                    }
                    ...
                    if (displayTop) {
                        // Top Face
                        mesh.addFace(ufr_coord, ubr_coord, ubl_coord);
                        mesh.addFace(ufr_coord, ubl_coord, ufl_coord);
                    }
                    ...
                    if (displayBottom) {
                        // Bottom Face
                        mesh.addFace(lfr_coord, lbl_coord, lbr_coord);
                        mesh.addFace(lfr_coord, lfl_coord, lbl_coord);
                    }
                }
            }
        }
