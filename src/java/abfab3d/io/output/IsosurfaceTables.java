...
public class IsosurfaceTables {

    static final int edgeTable[] = new int[]{ // 256 edges corresponding to calculated cubes index 
    ...
    //
    // this table has smaller max triangles count, but possible has manifld problem
    //
    static public int triTable_v1[][]= 
    {
        {},
        { 8, 3, 0},
        { 9, 0, 1},
