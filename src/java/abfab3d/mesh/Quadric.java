 ...
 * @author Alan Hudson
 */
public class Quadric extends StructDataDefinition {
    ...
    public static int create(StructMixedData src, int srcIdx, StructMixedData dest) {
    ...
    public static int create(double e00, double e01, double e02,  double e03, double e11, double e12, double e13,
    ...
    public static int create(Point3d p0, Point3d p1, double scale, StructMixedData dest) {
    ...
    public static int create(double a, double b, double c, double d, StructMixedData dest) {
    ...
    public static int create(Vector4d plane, StructMixedData dest) {
    ...
    public static int create(Point3d p0,Point3d p1,Point3d p2, StructMixedData dest){
