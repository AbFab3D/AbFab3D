 ...
 * @author Alan Hudson
 */
public class BoundingBoxUtilsDouble {
    /**
     ...
     */
    public void computeMinMax(final double[] coords, int vcount, double[] result) {
     ...
     * @param result An axis aligned bounds, minx,maxx,miny,maxy,minz,maxz
     */
    public void computeMinMax(final double[] coords, int[] indices, double[] result) {
        double minx = Double.POSITIVE_INFINITY;
        double miny = Double.POSITIVE_INFINITY;
        double minz = Double.POSITIVE_INFINITY;
        double maxx = Double.NEGATIVE_INFINITY;
     ...
     * @param result An axis aligned bounds, minx,maxx,miny,maxy,minz,maxz
     */
    public void computeMinMax(final double[] coords, int vcount, Matrix4f mat, double[] result) {
        double minx = Double.POSITIVE_INFINITY;
        double miny = Double.POSITIVE_INFINITY;
        double minz = Double.POSITIVE_INFINITY;
        double maxx = Double.NEGATIVE_INFINITY;
     ...
     * @param result An axis aligned bounds, minx,maxx,miny,maxy,minz,maxz
     */
    public void computeMinMax(final double[] coords, int[] indices, Matrix4f mat, double[] result) {
        double minx = Double.POSITIVE_INFINITY;
        double miny = Double.POSITIVE_INFINITY;
        double minz = Double.POSITIVE_INFINITY;
        double maxx = Double.NEGATIVE_INFINITY;
