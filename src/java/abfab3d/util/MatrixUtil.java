...
public class MatrixUtil {
    ...
    public static Matrix4d createMatrix(double[] vfCenter, double[] vfScale,
        ...
        if (doubleEq(vfScale[0], vfScale[1]) &&
            doubleEq(vfScale[0], vfScale[2])) {
     ...
     */
    private static boolean doubleEq(double val1, double val2) {
     ...
     * Helper method for creating Transforms from components.
     */
    public static Matrix4f createMatrix(float[] vfCenter, float[] vfScale,
        float[] vfRotation, float[] vfTranslation, float[] vfScaleOrientation) {
        ...
        if (floatEq(vfScale[0], vfScale[1]) &&
            ...
            float tempAxisNormalizer = (float) (
                1 / Math.sqrt(tempAxis.x * tempAxis.x +
                              tempAxis.y * tempAxis.y +
                              tempAxis.z * tempAxis.z));
