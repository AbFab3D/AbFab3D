 ...
 * @author Alan Hudson
 */
public class TestArrayAttributeGridShortIndexLong extends BaseTestAttributeGrid {

    /**
     * Creates a test suite consisting of all the methods that start with "test".
     */
    public static Test suite() {
        return new TestSuite(TestArrayAttributeGridShortIndexLong.class);
    }

    public void testToString() {
        Grid grid = new ArrayAttributeGridShortIndexLong(1, 1, 1, 0.001, 0.001);
    ...
    public void testCreateEmpty() {
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(100, 101, 102, 0.001, 0.001);
    ...
    public void testClone() {
        ...
        Grid grid = new ArrayAttributeGridShortIndexLong(size,size,size,voxelSize,sliceHeight);
        runClone(grid);
    }
    ...
    public void testSetGetByVoxelCoords() {
        ...
        grid = new ArrayAttributeGridShortIndexLong(3, 2, 2, 0.001, 0.001);
        setGetAllVoxelCoords(grid);

        grid = new ArrayAttributeGridShortIndexLong(11, 11, 11, 0.001, 0.001);
        setGetAllVoxelCoords(grid);

        grid = new ArrayAttributeGridShortIndexLong(100, 91, 85, 0.001, 0.001);
        setGetAllVoxelCoords(grid);
    }
    ...
    public void testGetStateByVoxel() {
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(10, 9, 8, 0.001, 0.001);
    ...
    public void testGetDataByCoord() {
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(1.0, 0.4, 0.5, 0.05, 0.01);
        getDataByCoord(grid);
    }
    ...
    public void testGetStateByCoord() {
        ...
        grid = new ArrayAttributeGridShortIndexLong(0.12, 0.11, 0.16, 0.05, 0.02);
    ...
    public void testsetAttribute() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(size, size, size, 0.001, 0.001);
        setAttribute(grid);
    }
    ...
    public void testShortMaterialRange() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(width, 1, 1, 0.001, 0.001);
    ...
    public void testFindCountByVoxelClass() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(width, height, depth, 0.05, 0.02);
    ...
    public void testFindVoxelClassIterator() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(width, height, depth, 0.001, 0.001);
        findVoxelClassIterator1(grid);

        grid = new ArrayAttributeGridShortIndexLong(width, height, depth, 0.001, 0.001);
    ...
    public void testGetGridCoords() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(xWorldCoord, yWorldCoord, zWorldCoord, voxelWidth, sliceHeight);
        getGridCoords(grid);
    }
    ...
    public void testGetWorldCoords() {
        ...
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight);
        getWorldCoords(grid);
    }
    ...
    public void testGetWidth() {
        ...
        // voxel coordinates
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(width, 50, 25, 0.05, 0.01);
        ...
        grid = new ArrayAttributeGridShortIndexLong(xcoord, 0.11, 0.16, voxelSize, 0.02);
        assertEquals("Width is not " + width, width, grid.getWidth());
    }
    ...
    public void testGetHeight() {
        ...
        // voxel coordinates
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(50, height, 25, 0.05, 0.02);
        ...
        grid = new ArrayAttributeGridShortIndexLong(0.12, ycoord, 0.16, 0.05, sliceHeight);
        assertEquals("Height is not " + height, height, grid.getHeight());
    }
    ...
    public void testGetDepth() {
        ...
        // voxel coordinates
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(50, 25, depth, 0.05, 0.01);
        ...
        grid = new ArrayAttributeGridShortIndexLong(0.12, 0.11, zcoord, voxelSize, 0.02);
        assertEquals("Depth is not " + depth, depth, grid.getDepth());
    }
    ...
    public void testGetSliceHeight() {
        ...
        // voxel coordinates
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(50, 25, 70, 0.05, sliceHeight);
        assertEquals("Slice height is not " + sliceHeight, sliceHeight, grid.getSliceHeight());

        // world coordinates
        grid = new ArrayAttributeGridShortIndexLong(0.12, 0.11, 0.12, 0.05, sliceHeight);
        assertEquals("Slice height is not" + sliceHeight, sliceHeight, grid.getSliceHeight());
    }
    ...
    public void testGetVoxelSize() {
        ...
        // voxel coordinates
        AttributeGrid grid = new ArrayAttributeGridShortIndexLong(50, 25, 70, voxelSize, 0.01);
        assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());

        // world coordinates
        grid = new ArrayAttributeGridShortIndexLong(0.12, 0.11, 0.12, voxelSize, 0.01);
        assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());
    }
