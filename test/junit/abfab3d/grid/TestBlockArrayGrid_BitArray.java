 ...
 * @version
 */
public class TestBlockArrayGrid_BitArray extends BaseTestGrid implements ClassTraverser {
	...
	public static Test suite() {
		return new TestSuite(TestBlockArrayGrid_BitArray.class);
	}
	...
	public void testBlockIndex() {
		BlockArrayGrid grid = new BlockArrayGrid(16, 16, 16, 1.0, 1.0, new int[] {3,3,3}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testSetGet() {
		BlockArrayGrid grid = new BlockArrayGrid(4096,4096,4096,1.0,1.0,new int[] {4,4,4}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testBlockArrayGridCopyConstructor() {
		BlockArrayGrid grid = new BlockArrayGrid(10, 9, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testCreateEmpty() {
		BlockArrayGrid grid = new BlockArrayGrid(100, 101, 102, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testSetGetByVoxelCoords() {
		Grid grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(16,8,8,0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(16, 16, 16, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(100, 91, 85, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelCoords(grid);
	}
	...
	public void testSetGetByWorldCoords() {
		...
		grid = new BlockArrayGrid(3,2,2,0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelByWorldCoords(grid);

		grid = new BlockArrayGrid(11, 11, 11, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		setGetAllVoxelByWorldCoords(grid);
	...
	public void testGetStateByCoord() {
		BlockArrayGrid grid = new BlockArrayGrid(1.0, 0.4, 0.5, 0.05, 0.01, new int[] {0,0,0}, BlockArrayGrid.BlockType.BitArray);
		...
		grid = new BlockArrayGrid(0.12, 0.11, 0.16, 0.05, 0.02, new int[] {0,0,0}, BlockArrayGrid.BlockType.BitArray);
...
//		assertEquals("State should be ", Grid.INTERIOR, grid.getState(0.1, 0.1, 0.15));
	...
	public void testFindCountByVoxelClass() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(width, height, depth, 0.05, 0.02, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testFindVoxelClassIterator() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(width, height, depth, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		...
		grid = new BlockArrayGrid(width, height, depth, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testGetGridCoords() {
		...
		Grid grid = new BlockArrayGrid(xWorldCoord, yWorldCoord, zWorldCoord, voxelWidth, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testGetWorldCoords() {
		...
		Grid grid = new BlockArrayGrid(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testGetSliceHeight() {
		...
		// voxel coordinates
		Grid grid = new BlockArrayGrid(50, 25, 70, 0.05, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		assertEquals("Slice height is not " + sliceHeight, sliceHeight, grid.getSliceHeight());

		// world coordinates
		grid = new BlockArrayGrid(0.12, 0.11, 0.12, 0.05, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		assertEquals("Slice height is not" + sliceHeight, sliceHeight, grid.getSliceHeight());
	}
	...
	public void testGetVoxelSize() {
		...
		// voxel coordinates
		Grid grid = new BlockArrayGrid(50, 25, 70, voxelSize, 0.01, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());

		// world coordinates
		grid = new BlockArrayGrid(0.12, 0.11, 0.12, voxelSize, 0.01, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
		assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());
	}
	...
	BlockArrayGrid grid = new BlockArrayGrid(size, size, size, 0.001, 0.001, new int[] {0,0,0}, BlockArrayGrid.BlockType.BitArray);
	...
	public void testClone() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(size, size, size, voxelSize, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.BitArray);
