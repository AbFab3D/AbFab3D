 ...
 * @version
 */
public class TestBlockArrayGrid_KeyValue extends BaseTestGrid implements ClassTraverser {
	...
	public static Test suite() {
		return new TestSuite(TestBlockArrayGrid_KeyValue.class);
	}
	...
	public void testBlockIndex() {
		BlockArrayGrid grid = new BlockArrayGrid(16, 16, 16, 1.0, 1.0, new int[] {3,3,3}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testSetGet() {
		BlockArrayGrid grid = new BlockArrayGrid(4096,4096,4096,1.0,1.0,new int[] {4,4,4}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testBlockArrayGridCopyConstructor() {
		BlockArrayGrid grid = new BlockArrayGrid(10, 9, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testCreateEmpty() {
		BlockArrayGrid grid = new BlockArrayGrid(100, 101, 102, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testSetGetByVoxelCoords() {
		Grid grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(8, 8, 8, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(16,8,8,0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(16, 16, 16, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);

		grid = new BlockArrayGrid(100, 91, 85, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelCoords(grid);
	}
	...
	public void testSetGetByWorldCoords() {
		...
		grid = new BlockArrayGrid(3,2,2,0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelByWorldCoords(grid);

		grid = new BlockArrayGrid(11, 11, 11, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		setGetAllVoxelByWorldCoords(grid);
	...
	public void testGetStateByCoord() {
		BlockArrayGrid grid = new BlockArrayGrid(1.0, 0.4, 0.5, 0.05, 0.01, new int[] {0,0,0}, BlockArrayGrid.BlockType.KeyValue);
		...
		grid = new BlockArrayGrid(0.12, 0.11, 0.16, 0.05, 0.02, new int[] {0,0,0}, BlockArrayGrid.BlockType.KeyValue);
...
//		assertEquals("State should be ", Grid.INTERIOR, grid.getState(0.1, 0.1, 0.15));
	...
	public void testFindCountByVoxelClass() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(width, height, depth, 0.05, 0.02, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testFindVoxelClassIterator() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(width, height, depth, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		...
		grid = new BlockArrayGrid(width, height, depth, 0.001, 0.001, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testGetGridCoords() {
		...
		Grid grid = new BlockArrayGrid(xWorldCoord, yWorldCoord, zWorldCoord, voxelWidth, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testGetWorldCoords() {
		...
		Grid grid = new BlockArrayGrid(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testGetSliceHeight() {
		...
		// voxel coordinates
		Grid grid = new BlockArrayGrid(50, 25, 70, 0.05, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		assertEquals("Slice height is not " + sliceHeight, sliceHeight, grid.getSliceHeight());

		// world coordinates
		grid = new BlockArrayGrid(0.12, 0.11, 0.12, 0.05, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		assertEquals("Slice height is not" + sliceHeight, sliceHeight, grid.getSliceHeight());
	}
	...
	public void testGetVoxelSize() {
		...
		// voxel coordinates
		Grid grid = new BlockArrayGrid(50, 25, 70, voxelSize, 0.01, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());

		// world coordinates
		grid = new BlockArrayGrid(0.12, 0.11, 0.12, voxelSize, 0.01, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
		assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());
	}
	...
	BlockArrayGrid grid = new BlockArrayGrid(size, size, size, 0.001, 0.001, new int[] {0,0,0}, BlockArrayGrid.BlockType.KeyValue);
	...
	public void testClone() {
		...
		BlockArrayGrid grid = new BlockArrayGrid(size, size, size, voxelSize, sliceHeight, new int[] {2,2,2}, BlockArrayGrid.BlockType.KeyValue);
