...
public class TestBlockBasedAttributeGridByte extends BaseTestAttributeGrid {
    ...
    public void testGetStateByCoord() {
        ...
        grid.setDataWorld(0.0, 0.0, 0.0, Grid.OUTSIDE, (byte) 0);
        grid.setDataWorld(0.95, 0.39, 0.45, Grid.INSIDE, (byte) 1);
        grid.setDataWorld(0.6, 0.1, 0.4, Grid.INSIDE, (byte) 2);
...
*/
    ...
    public void testGetMaterialByCoord() {
        ...
        assertEquals("State should be ", 0, grid.getAttributeWorld(0.0, 0.0, 0.0));
