 ...
 * @version
 */
public class TestOctreeGridByte extends BaseTestGrid implements ClassTraverser {
...
//        int[] stateDepth = {10, 6, 1};
        ...
        OctreeGridByte grid = new OctreeGridByte(width, height, depth, 0.05, 0.05);
...
//assertEquals("stop",1,0);
    ...
    public void testSimpleSetGet() {
        OctreeGridByte grid = new OctreeGridByte(4, 4, 4, 0.001, 0.001);
...
*/
    ...
    public void testOctreeGridByte() {
        ...
        grid = new OctreeGridByte(100, 101, 102, 0.001, 0.001);
    ...
    public void testGetStateByVoxel() {
        Grid grid = new OctreeGridByte(10, 9, 8, 0.001, 0.001);
...
/*
    public void testGetStateByCoord() {
        Grid grid = new OctreeGridByte(1.0, 1.0, 1.0, 0.01, 0.01);
        ...
        grid = new OctreeGridByte(0.12, 0.12, 0.12, 0.05, 0.05);
...
/*
    public void testGetMaterialByCoord() {
        Grid grid = new OctreeGridByte(1.0, 0.4, 0.5, 0.05, 0.01);
        ...
        // should expect width=3, height=6, depth=4
        // set data for a mid-voxel and test the bounds
        grid = new OctreeGridByte(0.12, 0.11, 0.16, 0.05, 0.05);
        grid.setData(0.06, 0.07, 0.08, Grid.INTERIOR, (byte)2);
...
*/
    ...
    public void testByteMaterialRange() {
        ...
        OctreeGridByte grid = new OctreeGridByte(width, 1, 1, 0.001, 0.001);
...
/*
    public void testGetGridCoords() {
        ...
        Grid grid = new OctreeGridByte(xWorldCoord, yWorldCoord, zWorldCoord, voxelWidth, sliceHeight);
...
*/
    ...
    public void testGetWorldCoords() {
        ...
        Grid grid = new OctreeGridByte(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight);
...
//System.out.println(maxBounds[0] + ", " + maxBounds[1] + ", " + maxBounds[2]);
    ...
    public void testGetWidth() {
        ...
        // voxel coordinates
        Grid grid = new OctreeGridByte(width, width, width, 0.05, 0.05);
        ...
        grid = new OctreeGridByte(xcoord, xcoord, xcoord, voxelSize, 0.05);
        assertEquals("Width is not " + width, width, grid.getWidth());
    }
    ...
    public void testGetHeight() {
        ...
        // voxel coordinates
        Grid grid = new OctreeGridByte(height, height, height, 0.05, 0.05);
        ...
        grid = new OctreeGridByte(ycoord, ycoord, ycoord, 0.05, sliceHeight);
        assertEquals("Height is not " + height, height, grid.getHeight());
    }
    ...
    public void testGetDepth() {
        ...
        // voxel coordinates
        Grid grid = new OctreeGridByte(depth, depth, depth, 0.05, 0.05);
        ...
        grid = new OctreeGridByte(zcoord, zcoord, zcoord, voxelSize, 0.05);
        assertEquals("Depth is not " + depth, depth, grid.getDepth());
    }
    ...
    public void testFindCount() {
        ...
        Grid grid = new OctreeGridByte(width, height, depth, 0.05, 0.05);
...
//System.out.println("count: " + expectedCount[j]);
        ...
        // test material 0
        int mat = 0;
        grid = new OctreeGridByte(width, height, depth, 0.05, 0.05);
        for (int x=0; x<width; x++) {
