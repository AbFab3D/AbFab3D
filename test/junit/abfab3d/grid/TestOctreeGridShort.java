...
/**
 * Tests the functionality of an OctreeAttributeGridShort.
 *
 * @author Alan Hudson
 * @version
 */
public class TestOctreeGridShort extends BaseTestAttributeGrid implements ClassAttributeTraverser {
    ...
    public void testFindVoxelClassIterator() {
        ...
        grid = new OctreeAttributeGridShort(width, height, depth, 0.001, 0.001);
...
//        int[] stateDepth = {10, 6, 1};
        ...
        OctreeAttributeGridShort grid = new OctreeAttributeGridShort(width, height, depth, 0.05, 0.05);
...
*/
    ...
    public void testSimpleSetGet() {
        OctreeAttributeGridShort grid = new OctreeAttributeGridShort(4, 4, 4, 0.001, 0.001);
...
*/
    ...
    public void testOctreeGridShort() {
        AttributeGrid grid =new OctreeAttributeGridShort(1, 1, 1, 0.001, 0.001);
        assertEquals("Array size is not 1", 1, grid.getWidth()*grid.getHeight()*grid.getDepth());

        grid = new OctreeAttributeGridShort(100, 101, 102, 0.001, 0.001);
    ...
    public void testSetGetByVoxelCoords() {
        ...
        grid = new OctreeAttributeGridShort(3,3,3,0.001, 0.001);
        setGetAllVoxelCoords(grid);

        grid = new OctreeAttributeGridShort(11, 11, 11, 0.001, 0.001);
        setGetAllVoxelCoords(grid);

        // Too slow for smoke tests
        grid = new OctreeAttributeGridShort(100, 100, 100, 0.001, 0.001);
        setGetAllVoxelCoords(grid);
    }
    ...
    public void testGetStateByVoxel() {
        AttributeGrid grid =new OctreeAttributeGridShort(10, 9, 8, 0.001, 0.001);
...
/*
    public void testGetStateByCoord() {
        AttributeGrid grid =new OctreeAttributeGridShort(1.0, 1.0, 1.0, 0.01, 0.01);
        ...
        grid = new OctreeAttributeGridShort(0.12, 0.12, 0.12, 0.05, 0.05);
...
*/
    ...
    public void testGetMaterialByVoxel() {
        AttributeGrid grid =new OctreeAttributeGridShort(10, 10, 10, 0.001, 0.001);
...
/*
    public void testGetMaterialByCoord() {
        AttributeGrid grid =new OctreeAttributeGridShort(1.0, 0.4, 0.5, 0.05, 0.01);
        ...
        // should expect width=3, height=6, depth=4
        // set data for a mid-voxel and test the bounds
        grid = new OctreeAttributeGridShort(0.12, 0.11, 0.16, 0.05, 0.05);
        grid.setData(0.06, 0.07, 0.08, Grid.INTERIOR, (byte)2);
...
/*
    public void testGetGridCoords() {
        ...
        AttributeGrid grid =new OctreeAttributeGridShort(xWorldCoord, yWorldCoord, zWorldCoord, voxelWidth, sliceHeight);
...
*/
    ...
    public void testGetWorldCoords() {
        ...
        AttributeGrid grid =new OctreeAttributeGridShort(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight);
...
//System.out.println(maxBounds[0] + ", " + maxBounds[1] + ", " + maxBounds[2]);
    ...
    public void testGetWidth() {
        ...
        // voxel coordinates
        AttributeGrid grid =new OctreeAttributeGridShort(width, width, width, 0.05, 0.05);
        ...
        grid = new OctreeAttributeGridShort(xcoord, xcoord, xcoord, voxelSize, 0.05);
        assertEquals("Width is not " + width, width, grid.getWidth());
    }
    ...
    public void testGetHeight() {
        ...
        // voxel coordinates
        AttributeGrid grid =new OctreeAttributeGridShort(height, height, height, 0.05, 0.05);
        ...
        grid = new OctreeAttributeGridShort(ycoord, ycoord, ycoord, 0.05, sliceHeight);
        assertEquals("Height is not " + height, height, grid.getHeight());
    }
    ...
    public void testGetDepth() {
        ...
        // voxel coordinates
        AttributeGrid grid =new OctreeAttributeGridShort(depth, depth, depth, 0.05, 0.05);
        ...
        grid = new OctreeAttributeGridShort(zcoord, zcoord, zcoord, voxelSize, 0.05);
        assertEquals("Depth is not " + depth, depth, grid.getDepth());
    }
