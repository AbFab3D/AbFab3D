...
/**
 * Tests the functionality of a GridShortIntervals.
 *
 * @author Alan Hudson
 */
public class TestShortIntervals extends BaseTestAttributeGrid {

    /**
     * Creates a test suite consisting of all the methods that start with "test".
     */
    public static Test suite() {
        return new TestSuite(TestShortIntervals.class);
    }

    public void testToString() {
        Grid grid = new GridShortIntervals(1, 1, 1, 0.001, 0.001);
    ...
    public void testCreateEmpty() {
        AttributeGrid grid = new GridShortIntervals(100, 101, 102, 0.001, 0.001);
    ...
    public void testClone() {
        ...
        Grid grid = new GridShortIntervals(size,size,size,voxelSize,sliceHeight);
        runClone(grid);
    }
    ...
    public void testSetGetByVoxelCoords() {
        ...
        grid = new GridShortIntervals(3, 2, 2, 0.001, 0.001);
        setGetAllVoxelCoords(grid);

        grid = new GridShortIntervals(11, 11, 11, 0.001, 0.001);
        setGetAllVoxelCoords(grid);

        grid = new GridShortIntervals(100, 91, 85, 0.001, 0.001);
        setGetAllVoxelCoords(grid);
    }
    ...
    public void testGetStateByVoxel() {
        AttributeGrid grid = new GridShortIntervals(10, 9, 8, 0.001, 0.001);
    ...
    public void testGetStateByCoord() {
        ...
        grid = new GridShortIntervals(new Bounds(0.15, 0.12, 0.20), 0.05, 0.02);
    ...
    public void testsetAttribute() {
        ...
        AttributeGrid grid = new GridShortIntervals(size, size, size, 0.001, 0.001);
        setAttribute(grid);
    }
    ...
    public void testShortMaterialRange() {
        ...
        AttributeGrid grid = new GridShortIntervals(width, 1, 1, 0.001, 0.001);
    ...
    public void testFindCountByVoxelClass() {
        ...
        AttributeGrid grid = new GridShortIntervals(width, height, depth, 0.05, 0.02);
    ...
    public void testFindVoxelClassIterator() {
        ...
        AttributeGrid grid = new GridShortIntervals(width, height, depth, 0.001, 0.001);
        findVoxelClassIterator1(grid);

        grid = new GridShortIntervals(width, height, depth, 0.001, 0.001);
    ...
    public void testGetGridCoords() {
        ...
        AttributeGrid grid = new GridShortIntervals(new Bounds(xWorldCoord, yWorldCoord, zWorldCoord), voxelWidth, sliceHeight);
        getGridCoords(grid);
    }
    ...
    public void testGetWorldCoords() {
        ...
        AttributeGrid grid = new GridShortIntervals(xVoxels, yVoxels, zVoxels, voxelWidth, sliceHeight);
        getWorldCoords(grid);
    }
    ...
    public void testGetWidth() {
        ...
        // voxel coordinates
        AttributeGrid grid = new GridShortIntervals(width, 50, 25, 0.05, 0.01);
        ...
        grid = new GridShortIntervals(new Bounds(xcoord, 0.11, 0.16), voxelSize, 0.02);
        assertEquals("Width is not " + width, width, grid.getWidth());
    }
    ...
    public void testGetHeight() {
        ...
        // voxel coordinates
        AttributeGrid grid = new GridShortIntervals(50, height, 25, 0.05, 0.02);
        ...
        grid = new GridShortIntervals(new Bounds(0.12, ycoord, 0.16), 0.05, sliceHeight);
        assertEquals("Height is not " + height, height, grid.getHeight());
    }
    ...
    public void testGetDepth() {
        ...
        // voxel coordinates
        AttributeGrid grid = new GridShortIntervals(50, 25, depth, 0.05, 0.01);
        ...
        grid = new GridShortIntervals(new Bounds(0.12, 0.11, zcoord), voxelSize, 0.02);
        assertEquals("Depth is not " + depth, depth, grid.getDepth());
    }
    ...
    public void testGetSliceHeight() {
        ...
        // voxel coordinates
        AttributeGrid grid = new GridShortIntervals(50, 25, 70, 0.05, sliceHeight);
        assertEquals("Slice height is not " + sliceHeight, sliceHeight, grid.getSliceHeight());

        // world coordinates
        grid = new GridShortIntervals(new Bounds(0.12, 0.11, 0.12), 0.05, sliceHeight);
        assertEquals("Slice height is not" + sliceHeight, sliceHeight, grid.getSliceHeight());
    }
    ...
    public void testGetVoxelSize() {
        ...
        // voxel coordinates
        AttributeGrid grid = new GridShortIntervals(50, 25, 70, voxelSize, 0.01);
        assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());

        // world coordinates
        grid = new GridShortIntervals(new Bounds(0.12, 0.11, 0.12), voxelSize, 0.01);
        assertEquals("Voxel size is not " + voxelSize, voxelSize, grid.getVoxelSize());
    }
