...
public class TestSetUnion extends BaseTestAttributeGrid {
    ...
    public void testBasic() {
        ...
        for (int x=3; x<7; x++) {
            grid3.setData(x, 5, 5, Grid.INSIDE, 1);
        }
        ...
        for (int y=2; y<8; y++) {
            for (int z=2; z<8; z++) {
                assertTrue("(2, " + y + ", " + z + ") state is not interior or exterior" ,
                        finalGrid.getState(2, y, z) == Grid.INSIDE || finalGrid.getState(2, y, z) == Grid.INSIDE);
            }
        }
        ...
        for (int y=2; y<8; y++) {
            for (int z=2; z<8; z++) {
                assertTrue("(7, " + y + ", " + z + ") state is not interior or exterior",
                        finalGrid.getState(7, y, z) == Grid.INSIDE || finalGrid.getState(7, y, z) == Grid.INSIDE);
            }
        }
        ...
        for (int x=3; x<7; x++) {
            assertTrue("(" + x + ", 5, 5) state is not interior",
                    finalGrid.getState(x, 5, 5) == Grid.INSIDE || finalGrid.getState(x, 5, 5) == Grid.INSIDE);
        }
    ...
    private AttributeGrid generateDumbBell() {
        ...
        for (int y=0; y<size; y++) {
            for (int z=0; z<size; z++) {
                setX(grid1, y, z, Grid.INSIDE, 1, 0, 4);
            }
        }
        ...
        for (int y=0; y<size; y++) {
            for (int z=0; z<size; z++) {
                setX(grid2, y, z, Grid.INSIDE, 1, 15, size-1);
            }
        }
        ...
        for (int y=bridgeHeight; y<bridgeHeight+bridgeThickness; y++) {
            for (int z=bridgeDepth; z<bridgeDepth+bridgeThickness; z++) {
                setX(grid3, y, z, Grid.INSIDE, 1, 4, 15);
            }
        }
