...
public class TestCanMoveMaterial extends BaseTestAttributeGrid {
    ...
    public void testBasic() {
        ...
        grid.setData(0,0,0, Grid.INSIDE, (byte) 1);
        grid.setData(0,0,1, Grid.INSIDE, (byte) 1);
        grid.setData(0,0,2, Grid.INSIDE, (byte) 1);
        grid.setData(0,0,3, Grid.INSIDE, (byte) 1);
        grid.setData(0,0,4, Grid.INSIDE, (byte) 1);

        // Add Object 2
        long mat2_count = 6;

        grid.setData(0,2,0, Grid.INSIDE, (byte) 2);
        grid.setData(0,2,1, Grid.INSIDE, (byte) 2);
        grid.setData(0,2,2, Grid.INSIDE, (byte) 2);
        grid.setData(0,2,3, Grid.INSIDE, (byte) 2);
        grid.setData(0,2,4, Grid.INSIDE, (byte) 2);
        grid.setData(0,2,5, Grid.INSIDE, (byte) 2);
...
//          grid.setData(i,0,0, Grid.INSIDE, (byte) 1);
//        }

        setX(grid, 0, 0, Grid.INSIDE, 1, startIndex+1, endIndex-1);
        setX(grid, 0, 0, Grid.OUTSIDE, 1, 101, 109);

        grid.setData(startIndex,0,0, Grid.INSIDE, 1);
        grid.setData(endIndex,0,0, Grid.INSIDE, 1);
        grid.setData(100,0,0, Grid.INSIDE, 1);
        grid.setData(110,0,0, Grid.INSIDE, 1);
...
//        grid.setData(5,yIndex,0, Grid.INSIDE, (byte) 2);
    ...
    private AttributeGrid setLargeGrid() {
        ...
        // Set different material
//        grid.setData(50,yIndex,0, Grid.INSIDE, (byte) 2);
